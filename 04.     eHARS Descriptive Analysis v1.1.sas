...
/* This is the same location (for simulation purposes) that the synthetic	*/
/* data set is saved in														*/
...
%let location_output =   &PATH.\eHARS &Sysdate.\Output &Sysdate;
filename 	log      	"&location_output\eHARS Descriptive Analysis Log &Sysdate..log";
